...
KUTE_TEST_CASE(kryptos_poly1305_le_bytes_to_num_tests)
    struct test_ctx {
        kryptos_u8_t *bytes;
        size_t bytes_total;
    ...
    while (test != test_end) {
        ...
        KUTE_ASSERT(memcmp(v, test->expected, sizeof(kryptos_poly1305_number_t)) == 0);
        test++;
    }
KUTE_TEST_CASE_END

KUTE_TEST_CASE(kryptos_poly1305_le_num_tests)
    struct test_ctx {
        kryptos_u8_t *bytes;
        size_t bytes_total;
        kryptos_poly1305_number_t expected;
...
KUTE_TEST_CASE(kryptos_poly1305_ld_raw_bytes_tests)
    struct test_ctx {
        kryptos_u8_t *bytes;
        size_t bytes_total;
        kryptos_poly1305_number_t expected;
...
KUTE_TEST_CASE(kryptos_poly1305_eq_tests)
    struct test_ctx {
    ...
    while (test != test_end) {
        KUTE_ASSERT(kryptos_poly1305_eq(test->x, test->y) == test->expected);
        test++;
    }
KUTE_TEST_CASE_END
...
KUTE_TEST_CASE(kryptos_poly1305_ne_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y;
        int expected;
    } test_vector[] = {
    ...
    while (test != test_end) {
        KUTE_ASSERT(kryptos_poly1305_ne(test->x, test->y) == test->expected);
        test++;
    }
KUTE_TEST_CASE_END

KUTE_TEST_CASE(kryptos_poly1305_gt_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y;
        int expected;
    } test_vector[] = {
    ...
    while (test != test_end) {
        KUTE_ASSERT(kryptos_poly1305_gt(test->x, test->y) == test->expected);
        test++;
    }
KUTE_TEST_CASE_END

KUTE_TEST_CASE(kryptos_poly1305_lt_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y;
        int expected;
    } test_vector[] = {
    ...
    while (test != test_end) {
        KUTE_ASSERT(kryptos_poly1305_lt(test->x, test->y) == test->expected);
        test++;
    }
KUTE_TEST_CASE_END

KUTE_TEST_CASE(kryptos_poly1305_ge_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y;
        int expected;
    } test_vector[] = {
    ...
    while (test != test_end) {
        KUTE_ASSERT(kryptos_poly1305_ge(test->x, test->y) == test->expected);
        test++;
    }
KUTE_TEST_CASE_END

KUTE_TEST_CASE(kryptos_poly1305_not_tests)
    struct test_ctx {
    ...
    while (test != test_end) {
        ...
        KUTE_ASSERT(memcmp(test->x, test->e, sizeof(kryptos_poly1305_number_t)) == 0);
        test++;
    }
KUTE_TEST_CASE_END

KUTE_TEST_CASE(kryptos_poly1305_lsh_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x;
        size_t level;
        kryptos_poly1305_number_t e;
...
KUTE_TEST_CASE(kryptos_poly1305_rsh_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x;
        size_t level;
        kryptos_poly1305_number_t e;
...
KUTE_TEST_CASE(kryptos_poly1305_sub_tests)
    struct test_ctx {
...
KUTE_TEST_CASE(kryptos_poly1305_inv_cmplt_tests)
    struct test_ctx {
...
KUTE_TEST_CASE(kryptos_poly1305_add_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y, e;
    } test_vector[] = {
#if defined(KRYPTOS_MP_EXTENDED_RADIX)
...
// TODO(Rafael): Fill up test vector when mp radix bit size is kryptos_u32_t.
        {
            {
                0x00000000,
                0x00000001, // TIP(Rafael): Less significant limb
                0x00000000,
                0x00000000,
                0x00000000,     // ((((((( For practical issues we store all mp numbers "upside-down" )))))))
                0x00000000,
                0x00000000,
                0x00000000,
                0x00000000,
                0x00000000,
                0x00000000  // TIP(Rafael): Most significant limb
            },
            {
                0x00000000,
                0x00000001,
...
KUTE_TEST_CASE(kryptos_poly1305_mul_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y, e;
    } test_vector[] = {
#if defined(KRYPTOS_MP_EXTENDED_RADIX)
        ...
        },
        {
            ...
            {
                0xA6144983, //INFO(Rafael): Does reality solid still? Does multiplication commutative still? ;)
                0x00000000,
                0x00000000,
                0x00000000,
                0x00000000,
...
KUTE_TEST_CASE(kryptos_poly1305_mul_digit_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x;
...
KUTE_TEST_CASE(kryptos_poly1305_div_tests)
    struct test_ctx {
        kryptos_poly1305_number_t x, y, ex, er;
    } test_vector[] = {
#if defined(KRYPTOS_MP_EXTENDED_RADIX)
        {
            {
    ...
    kryptos_poly1305_number_t r;

    while (test != test_end) {
        kryptos_poly1305_div(test->x, test->y, r);
        KUTE_ASSERT(memcmp(test->x, test->ex, sizeof(kryptos_poly1305_number_t)) == 0);
        KUTE_ASSERT(memcmp(r, test->er, sizeof(kryptos_poly1305_number_t)) == 0);
        test++;
    }
KUTE_TEST_CASE_END
