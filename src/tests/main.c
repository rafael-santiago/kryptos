...
/*
    ...
    CUTE_RUN_TEST(kryptos_realloc_tests);
...
/*
    ...
    CUTE_RUN_TEST(kryptos_base32_tests);
    CUTE_RUN_TEST(kryptos_base32_dsl_tests);
    CUTE_RUN_TEST(kryptos_base16_tests);
    CUTE_RUN_TEST(kryptos_base16_dsl_tests);
