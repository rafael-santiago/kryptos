...
CUTE_TEST_CASE(kryptos_dsl_tests)
    ...
    kryptos_run_cipher(shacal1, &task, "shacal1", 7, kKryptosECB);
    ...
    kryptos_run_cipher(shacal1, &task, "shacal1", 7, kKryptosCBC);
    ...
    kryptos_run_cipher(shacal2, &task, "shacal2", 7, kKryptosECB);
    ...
    kryptos_run_cipher(shacal2, &task, "shacal2", 7, kKryptosCBC);
    ...
    kryptos_run_cipher(noekeon, &task, "noekeon", 7, kKryptosECB);
    ...
    kryptos_run_cipher(noekeon, &task, "noekeon", 7, kKryptosCBC);
    ...
    kryptos_run_cipher(noekeon_d, &task, "noekeon_d", 9, kKryptosECB);
    ...
    kryptos_run_cipher(noekeon_d, &task, "noekeon_d", 9, kKryptosCBC);
    ...
    kryptos_run_cipher(gost_ds, &task, "gost-ds", 7, kKryptosECB);
    ...
    kryptos_run_cipher(gost_ds, &task, "gost-ds", 7, kKryptosCBC);
