...
CUTE_TEST_CASE(kryptos_poly1305_div_tests)
    struct test_ctx {
    ...
    while (test != test_end) {
        ...
        //printf("%lx %lx %lx %lx %lx %lx %lx %lx %lx %lx %lx\n", test->x[0], test->x[1], test->x[2], test->x[3], test->x[4], test->x[5], test->x[6], test->x[7], test->x[8], test->x[9], test->x[10]);
        CUTE_ASSERT(memcmp(test->x, test->ex, sizeof(kryptos_poly1305_number_t)) == 0);
        //printf("%.8lx %lx %lx %lx %lx %lx %lx %lx %lx %lx %lx\n", r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10]);
        CUTE_ASSERT(memcmp(r, test->er, sizeof(kryptos_poly1305_number_t)) == 0);
        test++;
    }
CUTE_TEST_CASE_END
