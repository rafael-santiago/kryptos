...
CUTE_DECLARE_TEST_CASE(kryptos_ecdsa_mk_key_pair_tests);

CUTE_DECLARE_TEST_CASE(kryptos_ecdsa_digital_signature_scheme_tests);

CUTE_DECLARE_TEST_CASE(kryptos_ecdsa_digital_signature_scheme_c99_tests);
