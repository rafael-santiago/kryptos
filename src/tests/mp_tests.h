...
CUTE_DECLARE_TEST_CASE(kryptos_mp_split_tests);
...
CUTE_DECLARE_TEST_CASE(kryptos_mp_modinv_rs_tests);
...
CUTE_DECLARE_TEST_CASE(kryptos_mp_barrett_reduction_tests);
