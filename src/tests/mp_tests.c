...
#else
    CUTE_ASSERT(mp->data[0] == 0x2233445566778899);
    CUTE_ASSERT(mp->data[1] == 0xFFEEDDCCBBAA0011);
#endif
#endif
    kryptos_del_mp_value(mp);
...
# if !defined(KRYPTOS_MP_EXTENDED_RADIX)
    ...
    mp = kryptos_hex_value_as_mp("1FFFF"
                                 ...
                                 "FFFFFFFF"
                                 "FFFEE600", 117);
    CUTE_ASSERT(mp->data[ 0] == 0xFFFEE600);
    CUTE_ASSERT(mp->data[ 1] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 2] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 3] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 4] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 5] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 6] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 7] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 8] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[ 9] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[10] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[11] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[12] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[13] == 0xFFFFFFFF);
    CUTE_ASSERT(mp->data[14] == 0x0001FFFF);
# else
    CUTE_ASSERT(mp->data[0] == 0x2233445566778899);
    CUTE_ASSERT(mp->data[1] == 0xFFEEDDCCBBAA0011);
    kryptos_del_mp_value(mp);
    ...
    CUTE_ASSERT(mp->data[0] == 0xFFFFFFFFFFFEE600);
    CUTE_ASSERT(mp->data[1] == 0xFFFFFFFFFFFFFFFF);
    CUTE_ASSERT(mp->data[2] == 0xFFFFFFFFFFFFFFFF);
    CUTE_ASSERT(mp->data[3] == 0xFFFFFFFFFFFFFFFF);
    CUTE_ASSERT(mp->data[4] == 0xFFFFFFFFFFFFFFFF);
    CUTE_ASSERT(mp->data[5] == 0xFFFFFFFFFFFFFFFF);
    CUTE_ASSERT(mp->data[6] == 0xFFFFFFFFFFFFFFFF);
    CUTE_ASSERT(mp->data[7] == 0x000000000001FFFF);
    kryptos_del_mp_value(mp);

    mp = kryptos_hex_value_as_mp("0000000000000000DEADBEEF", 24);
    CUTE_ASSERT(mp->data[0] == 0x00000000DEADBEEF);
    CUTE_ASSERT(mp->data[1] == 0x0000000000000000);
    kryptos_del_mp_value(mp);

    mp = kryptos_hex_value_as_mp("00000000DEADBEEFDEADBEEF", 24);
    CUTE_ASSERT(mp->data[0] == 0xDEADBEEFDEADBEEF);
    CUTE_ASSERT(mp->data[1] == 0x0000000000000000);
...
CUTE_TEST_CASE(kryptos_assign_mp_value_tests)
    ...
    CUTE_ASSERT(kryptos_mp_byte2bit(a->data_size) == 256);
#endif
...
# else
    ...
    CUTE_ASSERT(mp->data[1] == 0xDEADBEEFDEADBEEF);
    CUTE_ASSERT(mp->data[0] == 0x0);
# endif
#endif
    kryptos_del_mp_value(mp);
...
CUTE_TEST_CASE(kryptos_mp_split_tests)
    struct split_tests_ctx {
        kryptos_u8_t *src;
        kryptos_u8_t *expected_hi;
        kryptos_u8_t *expected_lo;
    } test_vector[] = {
        { "DEADBEEF0000000000000000DEADBEEF", "DEADBEEF00000000", "00000000DEADBEEF" },
        { "BEBACAFEFACAC0C0FACAC0C0BEBACAFE", "BEBACAFEFACAC0C0", "FACAC0C0BEBACAFE" },
        { "DEADBEEF0000000000000000DEADBEEFBEBACAFEFACAC0C0FACAC0C0BEBACAFE",
          "DEADBEEF00000000", "00000000DEADBEEFBEBACAFEFACAC0C0FACAC0C0BEBACAFE" },
        { "DEADBEEFDEADBEEFDEADBEEF", "00000000DEADBEEF", "DEADBEEFDEADBEEF" },
        { "DEADBEEF00000000BEEF", "0000000000000000DEAD", "BEEF00000000BEEF" },
        { "DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF"
          ...
          "DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF"
          "DEADBEEF" },
        { "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD"
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD"
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD"
          ...
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD"
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD" },
    }, *test = &test_vector[0], *test_end = test + sizeof(test_vector) / sizeof(test_vector[0]);
    kryptos_mp_value_t *src = NULL;
    kryptos_mp_value_t *number = NULL;
    kryptos_mp_value_t *exp_hi = NULL;
    kryptos_mp_value_t *exp_lo = NULL;
    kryptos_mp_value_t *hi = NULL;
    kryptos_mp_value_t *lo = NULL;
    while (test != test_end) {
        number = kryptos_hex_value_as_mp(test->src, strlen(test->src));
        CUTE_ASSERT(number != NULL);
        src = kryptos_assign_mp_value(&src, number);
        CUTE_ASSERT(src != NULL);
        CUTE_ASSERT(kryptos_mp_split(&hi, &lo, src, 1) == 1);
        CUTE_ASSERT(hi != NULL);
        CUTE_ASSERT(lo != NULL);
        exp_hi = kryptos_hex_value_as_mp(test->expected_hi, strlen(test->expected_hi));
        CUTE_ASSERT(exp_hi != NULL);
        exp_lo = kryptos_hex_value_as_mp(test->expected_lo, strlen(test->expected_lo));
        CUTE_ASSERT(exp_lo != NULL);
        /*printf("hi     = "); kryptos_print_mp(hi);
        printf("exp_hi = "); kryptos_print_mp(exp_hi);
        printf("lo     = "); kryptos_print_mp(lo);
        printf("exp_lo = "); kryptos_print_mp(exp_lo);*/
        CUTE_ASSERT(hi->data_size + lo->data_size == src->data_size);
        CUTE_ASSERT(kryptos_mp_eq(hi, exp_hi) == 1);
        CUTE_ASSERT(kryptos_mp_eq(lo, exp_lo) == 1);
        kryptos_del_mp_value(number);
        number = NULL;
        kryptos_del_mp_value(src);
        src = NULL;
        kryptos_del_mp_value(hi);
        hi = NULL;
        kryptos_del_mp_value(lo);
        lo = NULL;
        kryptos_del_mp_value(exp_hi);
        kryptos_del_mp_value(exp_lo);
        test++;
    }
CUTE_TEST_CASE_END
...
CUTE_TEST_CASE(kryptos_mp_mul_tests)
    ...
    struct mul_tests_ctx test_vector[] = {
        ...
        { "DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF"
          ...
          "DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF"
          "DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF",
          "C1B1CD13A4D13D4787F0AD7B6B101DAF4E2F8DE3314EFE17146E6E4A"
          "F78DDE7EDAAD4EB2BDCCBEE6A0EC2F1A840B9F4E672B0F824A4A7FB6"
          "2D69EFEA1089601DF3A8D051D6C84085B9E7B0B99D0720ED80269121"
          "63460155466571892984E1BD0CA451F0EFC3C224D2E33258B602A28C"
          "992212C07C4182F45F60F3284280635C259FD39008BF43C3EBDEB3F7"
          "CEFE242BB21D945F953D0493785C74C75B7BE4FB3E9B552F21BAC563"
          "04DA3596E7F9A5CACB1915FEAE3886329157F6667477669A5796D6CC"
          "B752ACDAD4333CA6F113CC730DF45C3F2AD4EC0B47B57BD764960BA3"
          "81769B6F9E572B3BBB37BB07D8184AD3F4F8DAA011D96A6C2EB9FA38"
          "4B9A8A04687B19D0855BA99CA23C3968BF1CC934DBFD5900F8DDE8CD"
          "15BE7899329F08654F7F98316C6027FD8940B7C9A6214795C301D761"
          "DFE2672DFCC2F6FA19A386C6368416925364A65E7045362A8D25C5F6"
          "AA0655C2C6E6E58EE3C7755B00A805271D8894F33A6924BF5749B48B"
          "742A4457910AD423ADEB63EFCACBF3BBE7AC8388048D1354216DA321" },
        { "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD"
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEAD"
          ...
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEAD",
          "C1B1CD136D98D65AA6091C772FE82D9D8A606BDAF23784E06EB7BB3E"
          "B486DC23530F0AA276D6336637665A0639258AA91BBDA969FB74E1EC"
          ...
          "54DDA1CBCFD56217172CF90EB42CB17AD97C5051988400DE9BCBA794"
          "7CDB50425E1AFED761329FA6206A561A4589EF09E2B9AD5D29E13E6D"
          "A50904A00E388DD167585BE2F28FDD3529A7B325D6E72C98EBF70A68"
          "BB3E7BFCAE4661AB9F95CB607095B8EE83ED1AC432E5103168446A27"
          "F5346772C9381F64DC521201E4E0D0011A02BABF0089809D57B3637C"
          "1C32313995640C3937DAE1D5D314B4F65383927210C55DB36F2C430E"
          "4E7606708AD4F3AA8C26AF2DA67DA446C9D757EAC22654E3078800A7"
          "DDCF057F4538A964F977B61B82E95222152066B7C099FADF30C91753"
          "FE4AA39C4C71C7F03BFB4C59681A788C79ABF51683C32928B75C9DD3"
          "9F6BD9C4F50D4690BB148A6132BDEF4DD6BD3AFD706E980AF265EB99"
          "AE1F40C80E0E9C35EBCFE98529B74CD229809242455FFD6E67313AFF"
        ...
        { "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          ...
          "BEEFDEAD",
          "DEADBEEF",
          "C1B1CD12C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695"
          "C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695C7833CBD"
          "8BD01695C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695"
          "C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695C7833CBD"
          "8BD01695C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695"
          "C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695C7833CBD"
          "8BD01695C7833CBD8BD01695C7833CBD8BD01695C7833CBD8BD01695"
        ...
        { "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          ...
          "DEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEFBEEFDEADDEADBEEF"
          "BEEFDEAD",
          "DEADBEEFBEEFDEADBEEFDEADDEADBEEF",
          "C1B1CD136D98D65A8A6CE900DC885D23A6A6A6A6A6A6A6A6A6A6A6A6"
          ...
          "A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6"
          "A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6A6"
          "A6A6A6A5E4F4D993390DD04C1C39BDA5CA1E4983" },
    };
    size_t test_vector_nr = sizeof(test_vector) / sizeof(test_vector[0]), tv;
...
CUTE_TEST_CASE(kryptos_mp_inv_tests)
...
CUTE_TEST_CASE(kryptos_mp_gen_prime_tests)
    ...
    printf(" *** Search for it in everywhere...\n");
    kryptos_del_mp_value(p);
...
CUTE_TEST_CASE(kryptos_mp_mod_tests)
    struct test_ctx {
        kryptos_u8_t *a;
        size_t a_size;
        kryptos_u8_t *b;
    ...
    for (t = 0; t < tv_nr; t++) {
        ...
        CUTE_ASSERT(a_value != NULL);
        b_value = kryptos_hex_value_as_mp(test_vector[t].b, test_vector[t].b_size);
        CUTE_ASSERT(b_value != NULL);
        e_value = kryptos_hex_value_as_mp(test_vector[t].e, test_vector[t].e_size);
        CUTE_ASSERT(e_value != NULL);
        CUTE_ASSERT(kryptos_mp_mod(&a_value, b_value) == 1);
        CUTE_ASSERT(a_value != NULL);
        CUTE_ASSERT(kryptos_mp_eq(a_value, e_value) == 1);
...
CUTE_TEST_CASE(kryptos_mp_barrett_reduction_tests)
    struct test_ctx {
        kryptos_u8_t *x;
        size_t x_size;
        kryptos_u8_t *m;
    ...
    CUTE_ASSERT(kryptos_mp_barrett_reduction(x, NULL, &sh, mod) == NULL);
    CUTE_ASSERT(kryptos_mp_barrett_reduction(x, &factor, NULL, mod) == NULL);
    CUTE_ASSERT(kryptos_mp_barrett_reduction(x, &factor, &sh, NULL) == NULL);

    mod = kryptos_hex_value_as_mp("11", 2);
    CUTE_ASSERT(mod != NULL);
...
CUTE_TEST_CASE(kryptos_mp_add_s_tests)
    struct test_ctx {
        kryptos_u8_t *a;
        size_t a_size;
        kryptos_u8_t *b;
    ...
    for (t = 0; t < tv_nr; t++) {
        ...
        CUTE_ASSERT(kryptos_mp_add_s(&a_value, b_value) != NULL);
...
CUTE_TEST_CASE(kryptos_mp_sub_s_tests)
    struct test_ctx {
        kryptos_u8_t *a;
        size_t a_size;
        kryptos_u8_t *b;
    ...
    for (t = 0; t < tv_nr; t++) {
        ...
        CUTE_ASSERT(e_value != NULL);
        //printf("A = "); kryptos_print_mp(a_value); printf("\n");
        CUTE_ASSERT(kryptos_mp_sub_s(&a_value, b_value) != NULL);
        //printf("B = "); kryptos_print_mp(b_value); printf("\n");
        //printf("R = "); kryptos_print_mp(a_value); printf("\n");
        //printf("E = "); kryptos_print_mp(e_value); printf("\n");
        CUTE_ASSERT(a_value != NULL);
...
CUTE_TEST_CASE(kryptos_mp_mul_s_tests)
    struct test_ctx {
        kryptos_u8_t *a;
        size_t a_size;
        kryptos_u8_t *b;
    ...
    for (t = 0; t < tv_nr; t++) {
        ...
        CUTE_ASSERT(e_value != NULL);
        //printf("A = "); kryptos_print_mp(a_value); printf("\n");
        CUTE_ASSERT(kryptos_mp_mul_s(&a_value, b_value) != NULL);
        //printf("B = "); kryptos_print_mp(b_value); printf("\n");
        //printf("R = "); kryptos_print_mp(a_value); printf("\n");
        //printf("E = "); kryptos_print_mp(e_value); printf("\n");
        CUTE_ASSERT(a_value != NULL);
