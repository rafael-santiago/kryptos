...
CUTE_DECLARE_TEST_CASE(kryptos_blake3_inc_hash_tests);

CUTE_DECLARE_TEST_CASE(kryptos_blake3_inc_hash_keyed_tests);

CUTE_DECLARE_TEST_CASE(kryptos_blake3N_tests);

CUTE_DECLARE_TEST_CASE(kryptos_blake3N_hash_macro_tests);

CUTE_DECLARE_TEST_CASE(kryptos_blake3N_inc_hash_tests);

CUTE_DECLARE_TEST_CASE(kryptos_blake3N_inc_hash_keyed_tests);
