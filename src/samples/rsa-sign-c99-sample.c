...
int main(int argc, char **argv) {
    ...
    kryptos_sign(rsa, alice, message, message_size, k_priv_alice, strlen((char *)k_priv_alice));
    ...
    kryptos_verify(rsa, bob, alice->out, alice->out_size, k_pub_alice, strlen((char *)k_pub_alice));
