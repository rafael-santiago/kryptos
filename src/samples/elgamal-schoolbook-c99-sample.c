...
int main(int argc, char **argv) {
    ...
    kryptos_u8_t *message = (kryptos_u8_t *)"moon over marin\x00";
    ...
    kryptos_run_cipher(elgamal, alice, k_pub, strlen((char *)k_pub));
    ...
    kryptos_run_cipher(elgamal, bob, k_priv, strlen((char *)k_priv));
