...
int main(int argc, char **argv) {
    ...
    ktask->out_size = 28;
    kryptos_hash(blake2sN, ktask, (kryptos_u8_t *)"Lenny", 5, 1);
    ...
    ktask->out_size = 48;
    kryptos_hash(blake2bN, ktask, (kryptos_u8_t *)"Lenny", 5, 1);
    ...
    ktask->key = (kryptos_u8_t *)"Blake2s";
    ktask->key_size = 7;
    ktask->out_size = 28;
    kryptos_hash(blake2sN, ktask, (kryptos_u8_t *)"Lenny", 5, 1);
    ...
    ktask->key = (kryptos_u8_t *)"Blake2b";
    ktask->key_size = 7;
    ktask->out_size = 48;
    kryptos_hash(blake2bN, ktask, (kryptos_u8_t *)"Lenny", 5, 1);
