...
int main(int argc, char **argv) {
    ...
    kryptos_u8_t *message = (kryptos_u8_t *)"This is weak!\x00\x00\x00";
    ...
    kryptos_rsa_setup(alice, k_pub_bob, strlen((char *)k_pub_bob));
    ...
    kryptos_rsa_setup(bob, k_priv_bob, strlen((char *)k_priv_bob));
