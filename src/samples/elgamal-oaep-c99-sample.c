...
int main(int argc, char **argv) {
    ...
    int exit_code = 0;
    kryptos_u8_t *k_pub = (kryptos_u8_t *)"-----BEGIN ELGAMAL PARAM P-----\n"
    ...
    kryptos_u8_t *k_priv = (kryptos_u8_t *)"-----BEGIN ELGAMAL PARAM P-----\n"
                                           "VRdEtMLDjy6jSMKvM83QDgAR1Y/2ZI9"
                                           "rDvT4nmFFBoV9/0q5HA+29b3V54aBOv"
                                           "G2Z31lqsfTWldx8AEnfs7N6gOlNmHC4"
                                           "xoST0rv/80gjdb+Kc+LWQAjmsSpdWBJ"
    ...
    kryptos_u8_t *message = (kryptos_u8_t *)"The Man With The Dogs";
    ...
    kryptos_run_cipher(elgamal_oaep, alice, k_pub, strlen((char *)k_pub),
    ...
    kryptos_run_cipher(elgamal_oaep, bob, k_priv, strlen((char *)k_priv),
                       label, NULL, kryptos_oaep_hash(sha384));
