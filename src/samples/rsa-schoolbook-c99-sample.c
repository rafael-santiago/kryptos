...
int main(int argc, char **argv) {
    ...
    kryptos_u8_t *message = (kryptos_u8_t *)"This is shorter but still weak!\x00";
    ...
    kryptos_run_cipher(rsa, alice, k_pub_bob, strlen((char *)k_pub_bob));
    ...
    kryptos_run_cipher(rsa, bob, k_priv_bob, strlen((char *)k_priv_bob));
