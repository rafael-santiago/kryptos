...
int main(int argc, char **argv) {
    ...
    kryptos_u8_t *message = (kryptos_u8_t *)"This is not deterministic!";
    ...
    kryptos_task_set_in(alice, message, strlen((char *)message));
    kryptos_task_set_encrypt_action(alice);
    kryptos_run_cipher(rsa_oaep, alice, k_pub_bob, strlen((char *)k_pub_bob), label, &label_size,
    ...
    kryptos_run_cipher(rsa_oaep, bob, k_priv_bob, strlen((char *)k_priv_bob), label, &label_size,
                       kryptos_oaep_hash(sha1));
