...
static void kryptos_rc2_ld_user_key(kryptos_u16_t *key, const kryptos_u8_t *user_key, const size_t user_key_size) {
    ...
    kryptos_ld_user_key_byte(key, 64, w, b, kp, kp_end, kryptos_rc2_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key, 64, w, b, kp, kp_end, kryptos_rc2_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key, 64, w, b, kp, kp_end, kryptos_rc2_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key, 64, w, b, kp, kp_end, kryptos_rc2_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key, 64, w, b, kp, kp_end, kryptos_rc2_ld_user_key_epilogue);
    ...
    kryptos_ld_user_key_epilogue(kryptos_rc2_ld_user_key_epilogue, key, 64, w, b, kp, kp_end);
}
