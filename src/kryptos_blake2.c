...
/*
KRYPTOS_IMPL_HASH_SIZE(blake2s224, KRYPTOS_BLAKE2S256_HASH_SIZE)

KRYPTOS_IMPL_HASH_INPUT_SIZE(blake2s224, KRYPTOS_BLAKE2S_BYTES_PER_BLOCK)

KRYPTOS_IMPL_HASH_PROCESSOR(blake2s224, ktask, kryptos_blake2_ctx, ctx, blake2s224_epilogue,
                            {
                                ctx.input = (*ktask)->in;
                                ctx.key = (*ktask)->key;
                                ctx.bb = KRYPTOS_BLAKE2S_BYTES_PER_BLOCK;
                                ctx.nn = KRYPTOS_BLAKE2S224_HASH_SIZE;
                                ctx.kk = (*ktask)->key_size;
                                ctx.ll = (*ktask)->in_size;
                            },
                            kryptos_blake2s(&ctx),
                            {
                                if (ctx.h == NULL || ctx.h_size != KRYPTOS_BLAKE2S224_HASH_SIZE) {
                                    (*ktask)->out_size = 0;
                                    (*ktask)->result = kKryptosProcessError;
                                    (*ktask)->result_verbose = "No memory to get a valid output.";
                                    goto kryptos_blake2s224_epilogue;
                                }
                                (*ktask)->out = ctx.h;
                            ...
                            {
                                if (ctx.h == NULL || ctx.h_size != KRYPTOS_BLAKE2S224_HASH_SIZE) {
                                    goto kryptos_blake2s224_no_memory;
                                }
                                (*ktask)->out_size = KRYPTOS_BLAKE2S224_HASH_SIZE << 1;
                                (*ktask)->out = (kryptos_u8_t *) kryptos_newseg((*ktask)->out_size + 1);
                                if ((*ktask)->out == NULL) {
                                    kryptos_blake2s224_no_memory:
                                        (*ktask)->out_size = 0;
                                        (*ktask)->result = kKryptosProcessError;
                                        (*ktask)->result_verbose = "No memory to get a valid output.";
                                        goto kryptos_blake2s224_epilogue;
                                }
                                kryptos_u64_to_hex((*ktask)->out      , 57, ((kryptos_u64_t)ctx.h[  0]) << 56 |
                                ...
                                kryptos_u64_to_hex((*ktask)->out +  16, 41, ((kryptos_u64_t)ctx.h[  8]) << 56 |
                                ...
                                kryptos_u64_to_hex((*ktask)->out +  32, 25, ((kryptos_u64_t)ctx.h[ 16]) << 56 |
                                ...
                                kryptos_u32_to_hex((*ktask)->out +  48,  9, ((kryptos_u64_t)ctx.h[ 24]) << 24 |
                                                                            ((kryptos_u64_t)ctx.h[ 25]) << 16 |
                                                                            ((kryptos_u64_t)ctx.h[ 26]) <<  8 |
                                                                            ((kryptos_u64_t)ctx.h[ 27]));
...
/*
KRYPTOS_IMPL_HASH_SIZE(blake2b384, KRYPTOS_BLAKE2B384_HASH_SIZE)

KRYPTOS_IMPL_HASH_INPUT_SIZE(blake2b384, KRYPTOS_BLAKE2B_BYTES_PER_BLOCK)

KRYPTOS_IMPL_HASH_PROCESSOR(blake2b384, ktask, kryptos_blake2_ctx, ctx, blake2b384_epilogue,
                            {
                                ctx.input = (*ktask)->in;
                                ctx.key = (*ktask)->key;
                                ctx.bb = KRYPTOS_BLAKE2B_BYTES_PER_BLOCK;
                                ctx.nn = KRYPTOS_BLAKE2B384_HASH_SIZE;
                                ctx.kk = (*ktask)->key_size;
                                ctx.ll = (*ktask)->in_size;
                            },
                            kryptos_blake2b(&ctx),
                            {
                                if (ctx.h == NULL || ctx.h_size != KRYPTOS_BLAKE2B384_HASH_SIZE) {
                                    (*ktask)->out_size = 0;
                                    (*ktask)->result = kKryptosProcessError;
                                    (*ktask)->result_verbose = "No memory to get a valid output.";
                                    goto kryptos_blake2b384_epilogue;
                                }
                                (*ktask)->out = ctx.h;
                                (*ktask)->out_size = ctx.h_size;
                                ctx.h = NULL;
                            ...
                            {
                                if (ctx.h == NULL || ctx.h_size != KRYPTOS_BLAKE2B384_HASH_SIZE) {
                                    goto kryptos_blake2b384_no_memory;
                                }
                                (*ktask)->out_size = KRYPTOS_BLAKE2B384_HASH_SIZE << 1;
                                (*ktask)->out = (kryptos_u8_t *) kryptos_newseg((*ktask)->out_size + 1);
                                if ((*ktask)->out == NULL) {
                                    kryptos_blake2b384_no_memory:
                                        (*ktask)->out_size = 0;
                                        (*ktask)->result = kKryptosProcessError;
                                        (*ktask)->result_verbose = "No memory to get a valid output.";
                                        goto kryptos_blake2b384_epilogue;
                                }
                                kryptos_u64_to_hex((*ktask)->out      , 97, ((kryptos_u64_t)ctx.h[  0]) << 56 |
                                                                            ((kryptos_u64_t)ctx.h[  1]) << 48 |
                                                                            ((kryptos_u64_t)ctx.h[  2]) << 40 |
                                                                            ((kryptos_u64_t)ctx.h[  3]) << 32 |
                                                                            ((kryptos_u64_t)ctx.h[  4]) << 24 |
                                                                            ...
                                                                            ((kryptos_u64_t)ctx.h[  6]) <<  8 |
                                                                            ((kryptos_u64_t)ctx.h[  7]));
                                kryptos_u64_to_hex((*ktask)->out +  16, 81, ((kryptos_u64_t)ctx.h[  8]) << 56 |
                                                                            ((kryptos_u64_t)ctx.h[  9]) << 48 |
                                                                            ((kryptos_u64_t)ctx.h[ 10]) << 40 |
                                                                            ((kryptos_u64_t)ctx.h[ 11]) << 32 |
                                                                            ((kryptos_u64_t)ctx.h[ 12]) << 24 |
                                                                            ...
                                                                            ((kryptos_u64_t)ctx.h[ 14]) <<  8 |
                                                                            ((kryptos_u64_t)ctx.h[ 15]));
                                kryptos_u64_to_hex((*ktask)->out +  32, 65, ((kryptos_u64_t)ctx.h[ 16]) << 56 |
                                                                            ((kryptos_u64_t)ctx.h[ 17]) << 48 |
                                                                            ((kryptos_u64_t)ctx.h[ 18]) << 40 |
                                                                            ((kryptos_u64_t)ctx.h[ 19]) << 32 |
                                                                            ((kryptos_u64_t)ctx.h[ 20]) << 24 |
                                                                            ...
                                                                            ((kryptos_u64_t)ctx.h[ 22]) <<  8 |
                                                                            ((kryptos_u64_t)ctx.h[ 23]));
                                kryptos_u64_to_hex((*ktask)->out +  48, 49, ((kryptos_u64_t)ctx.h[ 24]) << 56 |
                                                                            ((kryptos_u64_t)ctx.h[ 25]) << 48 |
                                                                            ((kryptos_u64_t)ctx.h[ 26]) << 40 |
                                                                            ((kryptos_u64_t)ctx.h[ 27]) << 32 |
                                                                            ((kryptos_u64_t)ctx.h[ 28]) << 24 |
                                                                            ...
                                                                            ((kryptos_u64_t)ctx.h[ 30]) <<  8 |
                                                                            ((kryptos_u64_t)ctx.h[ 31]));
                                kryptos_u64_to_hex((*ktask)->out +  64, 33, ((kryptos_u64_t)ctx.h[ 32]) << 56 |
                                ...
                                kryptos_u64_to_hex((*ktask)->out +  80, 17, ((kryptos_u64_t)ctx.h[ 40]) << 56 |
