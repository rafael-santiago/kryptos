...
void kryptos_rc6_ld_user_key(kryptos_u32_t *l, const kryptos_u8_t *key, const size_t key_size) {
    ...
    kryptos_ld_user_key_prologue(l, kryptos_rc6_K_NR, key, key_size, kp, kp_end, w, b, return);
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
        ...
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
        kryptos_ld_user_key_byte(l, kryptos_rc6_K_NR, w, b, kp, kp_end, kryptos_rc6_ld_user_key_epilogue);
    kryptos_ld_user_key_epilogue(kryptos_rc6_ld_user_key_epilogue, l, kryptos_rc6_K_NR, w, b, kp, kp_end);
}
