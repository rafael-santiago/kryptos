...
kryptos_u8_t kryptos_camellia_s1[] = { 112, 130,  44, 236, 179,  39, 192, 229, 228, 133,  87,  53, 234,  12, 174,  65,
...
kryptos_u8_t kryptos_camellia_s2[] = { 224,   5,  88, 217, 103,  78, 129, 203, 201,  11, 174, 106, 213,  24,  93, 130,
...
kryptos_u8_t kryptos_camellia_s3[] = { 56,  65,  22, 118, 217, 147,  96, 242, 114, 194, 171, 154, 117,   6,  87, 160,
...
kryptos_u8_t kryptos_camellia_s4[] = { 112,  44, 179, 192, 228,  87, 234, 174,  35, 107,  69, 165, 237,  79,  29, 146,
...
typedef void (*kryptos_camellia_block_processor)(kryptos_u8_t *block, struct kryptos_camellia_subkeys sks);
...
static void kryptos_camellia_block_decrypt_128(kryptos_u8_t *block, struct kryptos_camellia_subkeys sks);

static void kryptos_camellia_block_encrypt_192_256(kryptos_u8_t *block, struct kryptos_camellia_subkeys sks);

static void kryptos_camellia_block_decrypt_192_256(kryptos_u8_t *block, struct kryptos_camellia_subkeys sks);
...
static void kryptos_camellia_ld_128_user_key(kryptos_u32_t key[4], const kryptos_u8_t *user_key, const size_t user_key_size) {
    ...
    kryptos_ld_user_key_byte(key[w], kp, kp_end, kryptos_camellia_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key[w], kp, kp_end, kryptos_camellia_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key[w], kp, kp_end, kryptos_camellia_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key[w], kp, kp_end, kryptos_camellia_ld_user_key_epilogue);
    kryptos_ld_user_key_byte(key[w], kp, kp_end, kryptos_camellia_ld_user_key_epilogue);
    ...
    kryptos_ld_user_key_epilogue(kryptos_camellia_ld_user_key_epilogue, key, w, b, kp, kp_end);
}
